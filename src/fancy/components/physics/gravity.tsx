...
const Gravity = forwardRef<GravityRef, GravityProps>(
  (
    ...
    }, [engine, mouseConstraint, render, runner, bodiesMap, addTopWall, grabCursor, gravity.x, gravity.y, startEngine])
    ...
    }, [runner, render, frameId, isRunning])
    ...
    const reset = useCallback(() => {
      ...
      updateElements()
      handleResize()
    }, [stopEngine, bodiesMap, updateElements, handleResize, canvasSize.height, canvasSize.width])
